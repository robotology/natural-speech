...
class Model(object):
    ...
    def __init__(self, features, config):
        ...
        with tf.variable_scope('layer_1'):
            layer_1_weights = tf.get_variable('weights', [config.audio_feat_dimension, config.n_hidden],
        ...
        with tf.variable_scope('layer_2'):
            layer_2_weights = tf.get_variable('weights', [config.n_hidden, config.n_hidden],
                                              initializer=tf.contrib.layers.xavier_initializer())
        ...
        with tf.variable_scope('layer_3'):
            layer_3_weights = tf.get_variable('weights', [config.n_hidden, config.n_hidden],
                                              initializer=tf.contrib.layers.xavier_initializer())
        ...
        with tf.variable_scope('layer_4'):
            layer_4_weights = tf.get_variable('weights', [config.n_hidden, config.n_hidden],
                                              initializer=tf.contrib.layers.xavier_initializer())
        ...
        with tf.variable_scope('output'):
            output_weights = tf.get_variable('weights', [config.n_hidden, config.num_classes],
                                             initializer=tf.contrib.layers.xavier_initializer())
