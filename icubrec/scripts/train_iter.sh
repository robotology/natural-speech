...
for ((I=1,J=0;I<=$HEREST_SPLIT;)); do
    for ((T=0;T<$HEREST_THREADS&I<=$HEREST_SPLIT;T++,I++,J++)); do
        ...
        HERest -B -m $6 -A -T 1 -p $I -s $1/$3/stats_$3 -C $HTK_COMMON/$FEAT_CONFIG_FILE -I $1/$5 -t 250.0 150.0 2000.0 -S $1/train_temp_split_$T.scp -H $1/$2/macros -H $1/$2/hmmdefs -M $1/$3 $1/$4 > $1/THREAD_$T.log &
    done
    wait
...
if [[ $7 != "text" ]]
then
HERest -B -m $6 -A -T 1 -p 0 -s $1/$3/stats_$3 -C $HTK_COMMON/$FEAT_CONFIG_FILE -I $1/$5 -t 250.0 150.0 2000.0 -S $1/acc_files.txt -H $1/$2/macros -H $1/$2/hmmdefs -M $1/$3 $1/$4 >>$1/$3.log
else
HERest -m $6 -A -T 1 -p 0 -s $1/$3/stats_$3 -C $HTK_COMMON/$FEAT_CONFIG_FILE -I $1/$5 -t 250.0 150.0 2000.0 -S $1/acc_files.txt -H $1/$2/macros -H $1/$2/hmmdefs -M $1/$3 $1/$4 >>$1/$3.log
fi
